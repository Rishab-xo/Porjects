import { Wallet, ArrowUpCircle, Shield, Share2, CreditCard, FileText, Clock } from "lucide-react";
...
const FeaturesSection = ({features}) => {
  ...
  // Defining iconProps using the passed in color
      ...
      <div className="max-w-6xl mx-auto px-8 sm:px-12 lg:px-16">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Every thing you need for the file sharing 
          </h2>
